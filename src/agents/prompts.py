...
Centralizing prompts here improves maintainability and enables:
- Easier prompt iteration and versioning
- Cleaner agent implementation code
- Potential for dynamic prompt loading or A/B testing
"""
